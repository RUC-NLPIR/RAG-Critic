...
def data_loader(file_path, debug=False):
    ...
    input_data = []
    meta_data = []
    for i, entry in enumerate(tqdm(data[:100])):

    
        if "fever" in file_path:
 

            prompt_format = f"""Find the useful content from the provided documents, then answer the question. Please first analyze this question step-by-step, then answer the question directly. Your response should be SUPPORTS or REFUTES. Please provide use ’So the final answer is:’ as a prefix for the final answer. The following are given documents. 
            ...
            Please first analyze this question step-by-step, then answer the question directly. Your response should be SUPPORTS or REFUTES. Please provide use ’So the final answer is:’ as a prefix for the final answer. **Question**: {entry['question']} **Response**:"""
            ...
            prompt_format = f"""Find the useful content from the provided documents, then answer the question. Please first analyze this question step-by-step, then answer the question directly. Your response should be very concise. Please provide use ’So the final answer is:’ as a prefix for the final answer. The following are given documents. 
            ...
            Please first analyze this question step-by-step, then answer the question directly. Your response should be very concise. Please provide use ’So the final answer is:’ as a prefix for the final answer. **Question**: {entry['question']} **Response**:"""
